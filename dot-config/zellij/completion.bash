_zellij() {
    ...
    case "${cmd}" in
        zellij)
            ...
            ;;
        zellij__action)
            opts="-h --help write write-chars paste send-keys resize focus-next-pane focus-previous-pane move-focus move-focus-or-tab move-pane move-pane-backwards clear dump-screen dump-layout save-session edit-scrollback scroll-up scroll-down scroll-to-bottom scroll-to-top page-scroll-up page-scroll-down half-page-scroll-up half-page-scroll-down toggle-fullscreen toggle-pane-frames toggle-active-sync-tab new-pane edit switch-mode toggle-pane-embed-or-floating toggle-floating-panes show-floating-panes hide-floating-panes close-pane rename-pane undo-rename-pane go-to-next-tab go-to-previous-tab close-tab go-to-tab go-to-tab-name rename-tab undo-rename-tab go-to-tab-by-id close-tab-by-id rename-tab-by-id new-tab move-tab previous-swap-layout next-swap-layout override-layout query-tab-names start-or-reload-plugin launch-or-focus-plugin launch-plugin rename-session pipe list-clients list-panes list-tabs current-tab-info toggle-pane-pinned stack-panes change-floating-pane-coordinates toggle-pane-borderless set-pane-borderless detach switch-session set-pane-color help"
        ...
        zellij__action__edit)
            opts="-d -l -f -i -x -y -b -h --direction --line-number --floating --in-place --close-replaced-pane --cwd --x --y --width --height --pinned --near-current-pane --borderless --help <FILE>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zellij__action__launch__or__focus__plugin)
            opts="-f -i -m -c -s -h --floating --in-place --close-replaced-pane --move-to-focused-tab --configuration --skip-plugin-cache --help <URL>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zellij__action__launch__plugin)
            opts="-f -i -c -s -h --floating --in-place --close-replaced-pane --configuration --skip-plugin-cache --help <URL>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zellij__action__new__tab)
            opts="-l -n -c -h --layout --layout-dir --name --cwd --initial-plugin --close-on-exit --start-suspended --block-until-exit-success --block-until-exit-failure --block-until-exit --help <INITIAL_COMMAND>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zellij__action__override__layout)
            opts="-h --layout-dir --retain-existing-terminal-panes --retain-existing-plugin-panes --apply-only-to-active-tab --help <LAYOUT>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zellij__action__switch__session)
            opts="-l -c -h --tab-position --pane-id --layout --layout-dir --cwd --help <NAME>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zellij__delete__session)
            ...
            ;;
        zellij__edit)
            opts="-l -d -i -f -x -y -b -h --line-number --direction --in-place --close-replaced-pane --floating --cwd --x --y --width --height --pinned --near-current-pane --borderless --help <FILE>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zellij__pipe)
            ...
            ;;
        zellij__plugin)
            opts="-c -f -i -s -x -y -b -h --configuration --floating --in-place --close-replaced-pane --skip-plugin-cache --x --y --width --height --pinned --borderless --help <URL>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        zellij__run)
            opts="-d -f -i -n -c -s -x -y -b -h --direction --cwd --floating --in-place --close-replaced-pane --name --close-on-exit --start-suspended --x --y --width --height --pinned --stacked --blocking --block-until-exit-success --block-until-exit-failure --block-until-exit --near-current-pane --borderless --help <COMMAND>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
